...
void user_revision( NWType& nw,
    ...
    if (nw[v].group==nw[nb].group){
        ...
        if (extremism) {
           nw[v].tolerance=utils::tolerance_func(nw[v].opinion, tolerance_param);
           nw[nb].tolerance=utils::tolerance_func(nw[nb].opinion, tolerance_param);
        }
        return;
    }
